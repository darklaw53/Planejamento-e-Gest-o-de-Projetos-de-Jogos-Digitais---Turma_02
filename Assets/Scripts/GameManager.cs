...
public class GameManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        GameObject.FindGameObjectWithTag("BGM").GetComponent<PersistentBGM>().PlayMusic();
    ...
    void Quit()
    {
        point1.color = new Color(0, 0, 0, 0);
        point2.color = new Color(0, 0, 0, 0);
        point3.color = new Color(0, 0, 0, 0);
        pointColor1 = new Color(0, 0, 0, 0);
        pointColor2 = new Color(0, 0, 0, 0);
        pointColor3 = new Color(0, 0, 0, 0);
        oponentIntelect = 0;
        oponentDexterity = 0;
        oponentStrength = 0;
        roundNumber = 0;
